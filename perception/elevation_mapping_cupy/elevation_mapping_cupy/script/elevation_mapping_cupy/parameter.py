...
#
# import sys
# # sys.path.append('/home/chengsn/.local/lib/python3.8/site-packages')
# # 打印python版本
...
# # 查找simple_parsing模块
# print("simple_parsing module path: ", sys.modules.get("simple_parsing"))
# # 查找numpy模块
# print("numpy module path: ", sys.modules.get("numpy"))
